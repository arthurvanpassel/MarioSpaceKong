...
bootcamp.Kong = function (game) {};
bootcamp.Kong.prototype = {
    create: function () {
        bootcamp._this = this;
        ...
        // player-----------------------------------------------------------------------------------------
        this.player = this.add.sprite(bootcamp._WIDTH + 50, bootcamp._HEIGHT - 42, 'playerM');
    ...
    coinCreator: function (i, w) {
        i -= 15;
        w++;
        var coin = this.game.add.sprite(w, i, 'tilesM');
    ...
    beginAnim: function () {
        ...
        var greentube = bootcamp._this.add.sprite(screenWidth, screenHeight - 28, 'greenTube');
        greentube.angle = -90;
            ...
            setTimeout(function () {
                ...
                setTimeout(function () {
                    ...
                    setTimeout(function () {
                        ...
                        var greentube = bootcamp._this.add.sprite(screenWidth, screenHeight - 26, 'greenTube');
                        greentube.angle = -90;
                        bootcamp._this.physics.enable(greentube, Phaser.Physics.ARCADE);
                        greentube.body.allowGravity = false;
                        bootcamp._player.body.allowGravity = false;
